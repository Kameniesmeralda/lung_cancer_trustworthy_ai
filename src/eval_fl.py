...
def plot_confusion_matrix(y_true, y_pred, class_names):
    ...
    plt.tight_layout()
    plt.savefig("results/confusion_matrix_federated.png")
    plt.close()
...
def main():
    ...
    print("\n Chargement du modèle fédéré...")
    model_path = "results/model_federated_round5.pth"
    ...
    print("\n Évaluation terminée. Fichier généré : results/confusion_matrix_federated.png")
